...
DECLARE
  ...
  user_subscription_tier TEXT; -- Renamed variable to avoid ambiguity
BEGIN
  -- Get user's subscription tier
  SELECT subscription_tier INTO user_subscription_tier -- Updated variable name
  FROM public.profiles
  WHERE id = user_uuid;

  -- Set monthly limit based on subscription tier
  IF user_subscription_tier = 'enterprise' THEN -- Updated variable name
